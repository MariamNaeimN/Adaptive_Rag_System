...
# Set embeddings (using HuggingFace to match faissDB.py)
embd = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")

# Load the FAISS index from the directory (not the .py file)
vectorstore = FAISS.load_local(r"C:\Users\mari8947\OneDrive - Rackspace Inc\Desktop\Adaptive_rag\faiss_index", embd, allow_dangerous_deserialization=True)
...
### Generate
# Prompt - using fallback since langchain hub is not available
